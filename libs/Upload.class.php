...
class Upload {
	...
	/**
		...
		* @return 
	 */
	public function __construct($fileName='myFile',$uploadPath='uploads',$imgFlag='true',$maxSize=2097152,$allowExt=array('jpeg','jpg','gif','png'),$allowMime=array('image/jpeg','image/jpg','image/gif')){
	...
	protected function checkError(){
		if($this->fileInfo['error']===UPLOAD_ERR_OK){
			...
			switch($this->fileInfo['error']){
				case 1:
					$this->error = '超过了php.ini配置文件中upload_max_filesize选项的值';
					break;
				case 2:
	...
	protected function checkExt(){
		$this->ext = getExt($this->fileInfo['name']);
